    ...
    return (
        <div>
            ...
            <div className={`${styles.container} p-2`}>
                ...
                <Link to="/sig/technology" className={`${styles.section} ${location.pathname === '/sig/technology' ? styles.active : ''} d-flex align-items-center justify-content-start text-decoration-none`}>Tecnology</Link>
