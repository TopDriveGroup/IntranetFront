...
function FinantialDocumentsTopDriveGroupPage() {
        ...
        <div>
            ...
            <div className={`${styles.container} d-flex`}>
                ...
                <div className={`${styles.component} p-3`}>
                    <h2 className={`${styles.title} `}>Documentos Financieros Top Drive Group</h2>
...
export default FinantialDocumentsTopDriveGroupPage;