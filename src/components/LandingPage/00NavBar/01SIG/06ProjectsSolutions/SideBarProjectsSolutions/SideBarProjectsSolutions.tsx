...
function SideBarProjectsSolutions() {
    ...
    // RUTAS CON PARAMS
    const matchPolicies = useMatch('/sig/projects-and-solutions/policies');
        ...
        <div className={`${styles.container} overflow-y-auto position-sticky border-top-0`}>
            <div className={`${styles.container__Component} p-1`}>
                <div className={`${styles.container__Section} mb-2 d-flex align-items-center justify-content-end`}>
                    {location.pathname !== "/sig/projects-and-solutions" && (
                        <div>
                            <IoIosArrowRoundBack className={`${styles.icon__Back} `}/>
                            <Link to="/sig/projects-and-solutions" className={`${styles.button__Back} text-decoration-none`}>Ir a Inicio de Proyectos y Serv</Link>
                        </div>
                    )}
                    {location.pathname === "/sig/projects-and-solutions" && (
                        <div>
                ...
                <div onClick={togglePoliciesSubMenuOpen} className={`${styles.container__Section} ${(location.pathname === '/sig/projects-and-solutions/policies' || location.pathname === '/sig/projects-and-solutions/policies' || matchPolicies) ? styles.active : ''}  mb-2 d-flex align-items-center`}>
                ...
                {isPoliciesSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        <Link
                            to='/sig/projects-and-solutions/policies'
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/sig/projects-and-solutions/policies' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                            Políticas
                        </Link>
                    </div>
                ...
                <div onClick={toggleFormsSubMenuOpen} className={`${styles.container__Section} ${(location.pathname === '/sig/projects-and-solutions/forms' || location.pathname === '/sig/projects-and-solutions/forms') ? styles.active : ''}  mb-2 d-flex align-items-center`}>
                    <div className={`${styles.container__Icon} d-flex align-items-center justify-content-center`}>
                        <MdNavigateNext className={styles.icon__Deployment}/>
                    </div>
                    <div className={`${styles.section} d-flex align-items-center justify-content-start text-decoration-none`}>
                ...
                {isFormsSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        <Link
                            to='/sig/projects-and-solutions/forms'
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/sig/projects-and-solutions/forms' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                ...
                <div onClick={toggleProceduresSubMenuOpen} className={`${styles.container__Section} ${(location.pathname === '/sig/projects-and-solutions/procedures' || location.pathname === '/sig/projects-and-solutions/procedures') ? styles.active : ''}  mb-2 d-flex align-items-center`}>
                    <div className={`${styles.container__Icon} d-flex align-items-center justify-content-center`}>
                        <MdNavigateNext className={styles.icon__Deployment}/>
                    </div>
                    <div className={`${styles.section} d-flex align-items-center justify-content-start text-decoration-none`}>
                ...
                {isProceduresSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        <Link
                            to='/sig/projects-and-solutions/procedures'
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/sig/projects-and-solutions/procedures' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                            Formularios de creación
                        </Link>
                    </div>
                ...
                <div onClick={toggleRegistersSubMenuOpen} className={`${styles.container__Section} ${(location.pathname === '/sig/projects-and-solutions/registers' || location.pathname === '/sig/projects-and-solutions/registers') ? styles.active : ''}  mb-2 d-flex align-items-center`}>
                    <div className={`${styles.container__Icon} d-flex align-items-center justify-content-center`}>
                        <MdNavigateNext className={styles.icon__Deployment}/>
                    </div>
                    <div className={`${styles.section} d-flex align-items-center justify-content-start text-decoration-none`}>
                ...
                {isRegistersSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        <Link
                            to='/sig/projects-and-solutions/registers'
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/sig/projects-and-solutions/registers' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                            Registro Uno
                        </Link>
                    </div>
                ...
                <div onClick={toggleIndicatorsSubMenuOpen} className={`${styles.container__Section} ${(location.pathname === '/sig/projects-and-solutions/indicators' || location.pathname === '/sig/projects-and-solutions/indicators') ? styles.active : ''}  mb-2 d-flex align-items-center`}>
                    <div className={`${styles.container__Icon} d-flex align-items-center justify-content-center`}>
                        <MdNavigateNext className={styles.icon__Deployment}/>
                    </div>
                    <div className={`${styles.section} d-flex align-items-center justify-content-start text-decoration-none`}>
                ...
                {isIndicatorsSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        <Link
                            to='/sig/projects-and-solutions/indicators'
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/sig/projects-and-solutions/indicators' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                            Registro Uno
                        </Link>
                    </div>
...
export default SideBarProjectsSolutions;