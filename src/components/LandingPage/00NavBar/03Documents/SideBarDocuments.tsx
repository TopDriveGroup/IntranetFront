        ...
        <div className={`${styles.container} overflow-y-auto position-sticky border-top-0`}>
            <div className={`${styles.container__Component} p-1`}>
                ...
                <div onClick={togglePoliciesSubMenuOpen}
                    ...
                    location.pathname === '/documents/finantial/finantial/world-electrict-telecom-solutions' ||
                ...
                {isPoliciesSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        ...
                        <Link
                            to='/documents/finantial/world-electrict-telecom-solutions'
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/documents/finantial/world-electrict-telecom-solutions' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                ...
                <div onClick={toggleFormsSubMenuOpen}
                    className={`${styles.container__Section}
                    ${(location.pathname === '/documents/marketing') ? styles.active : ''} 
                ...
                {isFormsSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        <Link
                            ...
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/documents/marketing' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                ...
                <div onClick={toggleProceduresSubMenuOpen}
                    className={`${styles.container__Section}
                    ${(location.pathname === '/documents/administrative') ? styles.active : ''} 
                    mb-2 d-flex align-items-center`}
                >
                    <div className={`${styles.container__Icon} d-flex align-items-center justify-content-center`}>
                        <MdNavigateNext className={styles.icon__Deployment}/>
                ...
                {isProceduresSubMenuOpen && (
                    <div className={styles.sub__Menu}>
                        <Link
                            to='/documents/administrative'
                            className={`${styles.link__Sub_Menu} ${location.pathname === '/documents/administrative' ? styles.active__Sub_Menu : ''} text-decoration-none`}
                        >
                            Formularios de creación
                        </Link>
                    </div>
